...
- Cải thiện đáng kể khả năng mở rộng và hiệu suất bằng cách xử lý các object độc lập
cùng lúc
...
Để xây dựng smart contract trong Move, trước tiên ta phải hiểu về kiểu dữ liệu (data types) vì chúng là nền tảng để mô tả tài sản, quyền sở hữu và hành vi. Move cung cấp cả **primitive types (cơ bản)** và **collection types (tổ hợp)**.
