...
* Artifact: Các file được tạo ra sau khi compile package

![](https://amethyst-fascinating-tortoise-826.mypinata.cloud/ipfs/bafkreiecqxitbdi6nwy5m6zwhrorjtjc437xlytaa3xcp3kim3o7lsomuy)
...
Để tạo package mới, bạn có thể sử dụng lệnh CLI Sui move new . Mục đích của Move package system là để cho phép các developer có thể define dễ dàng nơi chứa các move code, bạn có thể import và use packages ở file move code khác.
...
![](https://amethyst-fascinating-tortoise-826.mypinata.cloud/ipfs/bafkreibegt4eitokbmrxkkwzsttn5ubwq5ggc2e5imw2mr3efiyvunaive)
...
![](https://amethyst-fascinating-tortoise-826.mypinata.cloud/ipfs/bafybeieryyope4eudq56v5rraimmml5pffkiynd5tthbcn7io7hn253fju)
...
Ở đây bạn cũng có thể xem như module là thư viện con trong package. Tính chất đóng gói (encapsulation) của module giúp cho việc phát triển smart contract trở nên module hóa, có khả năng kết hợp linh hoạt, đồng thời nâng cao khả năng tái sử dụng mã nguồn và tính bảo mật.
...
* `<ModuleName>` đơn giản đại diện cho tên của module đó. Sau đây là một số Sui modules mà bạn sẽ thường sử dụng:
...
### Sự khác biệt giữa public và entry trong Sui Move¶
...
Còn `entry fun` thì là một kiểu đặc biệt. Hàm có entry chỉ được gọi trực tiếp từ transaction — tức là từ một Programmable Transaction Block (PTB). Frontend có thể gọi, ví có thể gọi.
...
Một chi tiết nữa là entry thường đi chung với `&mut TxContext`. Nhưng entry không phải không có giới hạn. Vì để đảm bảo an toàn cho hệ thống sẽ có một số quy tắc sau.


### Rule ràng buộc riêng của Sui đối với entry
